...
var Pair = /*#__PURE__*/function () {
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount, fee) {
    if (fee === undefined) fee = inputAmount.token.chainId === ChainId.HECO_MAINNET || inputAmount.token.chainId === ChainId.HECO_TESTNET ? 9970 : 997;
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount, fee) {
    if (fee === undefined) fee = outputAmount.token.chainId === ChainId.HECO_MAINNET || outputAmount.token.chainId === ChainId.HECO_TESTNET ? 9970 : 997;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    var fee;
    if (route.chainId === ChainId.BSC_MAINNET && route.input.symbol === 'BUSD' && route.output.symbol === 'USDT' || route.input.symbol === 'USDT' && route.output.symbol === 'BUSD') fee = 1000;
